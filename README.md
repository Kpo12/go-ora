...
```
    - To use version 2 you should import github.com/kpo12/go-ora/v2
...
see [examples/windows_os_auth](https://github.com/kpo12/go-ora/blob/master/examples/windows_os_auth/main.go) for more help
```golang
urlOptions := map[string]string {
...
* Complete code found in [examples/kerberos](https://github.com/kpo12/go-ora/blob/master/examples/kerberos/main.go)
  ```golang
  urlOptions := map[string]string{
      "AUTH TYPE":  "KERBEROS",
  }
...
// check for errors
```
complete example found in [examples/crud](https://github.com/kpo12/go-ora/blob/master/examples/crud/main.go)
* ### input parameters
...
* ### Lob Types
  ...
  * complete code is found in [examples/clob](https://github.com/kpo12/go-ora/blob/master/examples/clob/main.go)
> input parameters
```golang
...
* ### BFile (v2.7.23)
  ...
  * complete code for BFile found in [examples/bfile](https://github.com/kpo12/go-ora/blob/master/examples/bfile/main.go)
...
* ### Named Parameters
  ...
  * complete code for named parameters found in [examples/named_pars](https://github.com/kpo12/go-ora/blob/master/examples/named_pars/main.go)
...
complete code can be found in [examples/struct_par](https://github.com/kpo12/go-ora/blob/master/examples/struct_par/main.go)

* ### Arrays
> passing array as a parameter is useful in the following situations
> * Multiple insert/merge
> * Associative Array. You can find complete code in [examples/array](https://github.com/kpo12/go-ora/blob/master/examples/arrays/main.go)
> * UDT array. You can find complete code in [examples/udt_array](https://github.com/kpo12/go-ora/blob/master/examples/udt_array/main.go)
...
> complete code for bulk-insert/merge can be found in [examples/merge](https://github.com/kpo12/go-ora/blob/master/examples/merge/main.go)
...
>   * [examples/UDT](https://github.com/kpo12/go-ora/blob/master/examples/UDT/main.go)
>   * [examples/nested_udt_array](https://github.com/kpo12/go-ora/blob/master/examples/nested_udt_array/main.go) a complete example of nested objects (2 level), nested arrays 
>   as input/output parameters
>   * [examples/regular_type_array](https://github.com/kpo12/go-ora/blob/master/examples/regular_type_array/main.go) a complete example for all supported regullar type arrays
>   * [examples/null_udt](https://github.com/kpo12/go-ora/blob/master/examples/null_udt/main.go) example represent null object as input and output
>   * [examples/varray](https://github.com/kpo12/go-ora/blob/master/examples/varray/main.go) for varray types
...
> complete code for RefCursor as output parameter found in [examples/refcursor](https://github.com/kpo12/go-ora/blob/master/examples/refcursor/main.go)
...
```
complete code for mapping refcursor to sql.Rows is found in [example/refcursor_to_rows](https://github.com/kpo12/go-ora/blob/master/examples/refcursor_to_rows/main.go)
...
* testing file [prefetch large blob](https://github.com/kpo12/go-ora/blob/v2.8.8/v2/TestIssues/prefetch_large_blob_test.go)
...
import (
  "database/sql"
  db_out "github.com/kpo12/go-ora/dbms_output"
